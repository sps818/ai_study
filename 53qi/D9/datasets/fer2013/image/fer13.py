...
def saveImageFromFer2013(file):
    ...
    for index in range(len(faces_data)):
        ...
        Image.fromarray(image).convert('RGB').save(imageName)
        imageCount = index
    print('总共有' + str(imageCount) + '张图片')


if __name__ == '__main__':
    saveImageFromFer2013('/Users/yaoxiaoying/Documents/01-工作/03.计算机视觉/06.人脸项目/02.code/05.表情识别/emoCode/datasets/fer2013/fer2013.csv')